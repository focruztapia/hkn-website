const OfficersData = [
	...
	},
	{
		...
		position: "Workshop",
		email: "replace",
        bio: "Hi everyone, I'm Sahil! I'm a 2nd year EE major and I am one of the workshop chairs for this year. I'll be working with the other workshop chairs, Zefyr and Dylan, to create a series of interesting workshops that will teach you the stuff you won't necessarily learn in class but will need to know for internship/industry experience! Please feel free to reach out to me with any suggestions you might have for new workshops, or if you need advice on classes, class planning, how to get into a research lab etc, or if you just want to chat with someone :)"
	},
  {
		id: 8,
		name: "Stan Xie",
